      ...
      <div className="scene">
        <div className="left-pane">
          <div className="card info-card">
            <h2 className="info-title">Have something worth building?</h2>
            <p className="info-sub">Tell us what you're thinking. We'll help turn the idea into a practical technology solution.</p>

            <div className="social-row">
              <a className="social-btn" href="https://linkedin.com" target="_blank" rel="noreferrer">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.98 3.5A2.5 2.5 0 1 0 5 8.5a2.5 2.5 0 0 0-.02-5ZM3 9.98h4V21H3V9.98Zm7 0h3.83v1.51h.05c.53-1 1.85-2.06 3.8-2.06 4.07 0 4.82 2.68 4.82 6.16V21h-4v-4.9c0-1.17-.02-2.67-1.63-2.67-1.64 0-1.89 1.28-1.89 2.59V21h-4V9.98Z"/></svg>
                LinkedIn
              </a>
              <a className="social-btn" href="https://instagram.com" target="_blank" rel="noreferrer">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2c2.72 0 3.06.01 4.12.06 1.06.05 1.79.22 2.43.46.66.25 1.22.6 1.77 1.15.5.5.85 1.02 1.15 1.77.24.64.41 1.37.46 2.43.05 1.06.06 1.4.06 4.12s-.01 3.06-.06 4.12c-.05 1.06-.22 1.79-.46 2.43a4.9 4.9 0 0 1-1.15 1.77c-.5.5-1.02.85-1.77 1.15-.64.24-1.37.41-2.43.46-1.06.05-1.4.06-4.12.06s-3.06-.01-4.12-.06c-1.06-.05-1.79-.22-2.43-.46a4.9 4.9 0 0 1-1.77-1.15 4.9 4.9 0 0 1-1.15-1.77c-.24-.64-.41-1.37-.46-2.43C2.01 15.06 2 14.72 2 12s.01-3.06.06-4.12c.05-1.06.22-1.79.46-2.43.25-.66.6-1.22 1.15-1.77.5-.5 1.02-.85 1.77-1.15.64-.24 1.37-.41 2.43-.46C8.94 2.01 9.28 2 12 2Zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 8.2a3.2 3.2 0 1 1 0-6.4 3.2 3.2 0 0 1 0 6.4Zm5.4-9.6a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Z"/></svg>
                Instagram
              </a>
            </div>

            <div className="info-list">
              <a className="info-row" href="tel:+910000000000">
              ...
              <a className="info-row" href="mailto:care@bitntech.ai">
        ...
        <main className="stage" id="stage">
          ...
          <form className="card" id="form" noValidate>
            ...
            <label className="field">
              ...
              <input id="company" type="text" placeholder="Company / organization (optional)" autoComplete="organization" aria-label="Company or organization" />
            </label>
            ...
            <label className="field field--textarea">
              ...
              <textarea id="details" placeholder="Anything else? (optional)" aria-label="Extra details" rows={3}></textarea>
            </label>

            <button className="btn" id="sendBtn" type="submit">
              <span className="btn-bolt" aria-hidden="true">⚡</span>
              <span className="btn-label" id="btnLabel">SEND</span>
            </button>
