...
const FAQ: FaqEntry[] = [
  ...
  { keywords: ['contact', 'email', 'phone', 'reach', 'call'], answer: 'You can reach us at care@bitntech.ai or +91 00000 00000, or use the form on the Contact page.', mood: 'watching' },
...
const FALLBACK: FaqReply = { answer: 'Hmm, not sure about that one. Email care@bitntech.ai and a human will help.', mood: 'watching' }
