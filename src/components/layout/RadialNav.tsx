...
import { Home, Cpu, Code2, Info, Mail, type LucideIcon } from 'lucide-react'
...
const NAV_ITEMS: MenuItem[] = [
  ...
  { id: 2, label: 'Hardware', icon: Cpu, path: '/hardware' },
  { id: 3, label: 'Software', icon: Code2, path: '/software' },
  { id: 4, label: 'About', icon: Info, path: '/about' },
  { id: 5, label: 'Contact', icon: Mail, path: '/contact' },
]
